...
(function () {
  ...
  .controller('CatCtrl', ["$scope", "$stateParams", function CatController ($scope, $stateParams) {
    var data = {
      history: [
        {
  ...
  .controller('ResCtrl', ["$scope", "$stateParams", function ResController ($scope, $stateParams) {
